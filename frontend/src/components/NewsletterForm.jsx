      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <input
            ...
            className="flex-1 rounded-lg border text-black border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
          <button
            type="submit"
